...
function toggleDescription(type) {
  ...
  if (type === 'school') {
    if (schoolDescription.style.display === 'block') {
      ...
      collegeDescription.style.display = 'none'; // Hide college description if it's visible
    }
    ...
    if (collegeDescription.style.display === 'block') {
      ...
      schoolDescription.style.display = 'none'; // Hide school description if it's visible
    }
  }
